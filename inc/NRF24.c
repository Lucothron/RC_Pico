...
void rx_message(payload_prx_t* msg) {
  ...
  (*msg).moisture_1 = message.payload.moisture_1;
  (*msg).moisture_2 = message.payload.moisture_2;
  (*msg).moisture_3 = message.payload.moisture_3;
  (*msg).moisture_4 = message.payload.moisture_4;
  (*msg).moisture_5 = message.payload.moisture_5;
  (*msg).moisture_6 = message.payload.moisture_6;
